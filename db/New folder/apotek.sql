...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 12 Jan 2020 pada 03.33
...
--
-- Dumping data untuk tabel `detail_kunjungan`
--
...
--
-- Struktur dari tabel `detail_obat_praktik`
--
...
--
-- Dumping data untuk tabel `detail_obat_praktik`
--
...
--
-- Struktur dari tabel `detail_pembelian_obat_praktik`
--
...
--
-- Dumping data untuk tabel `detail_pembelian_obat_praktik`
--
...
--
-- Stand-in struktur untuk tampilan `detail_pembelian_op`
...
--
-- Struktur dari tabel `detail_tmp`
--
...
--
-- Struktur dari tabel `obat_praktik`
--
...
--
-- Dumping data untuk tabel `obat_praktik`
--
...
--
-- Struktur dari tabel `opname_obat`
--
...
--
-- Struktur dari tabel `opname_obat_praktik`
--
...
--
-- Struktur dari tabel `pembelian_obat_praktik`
--
...
--
-- Dumping data untuk tabel `pembelian_obat_praktik`
--
...
--
-- Struktur untuk view `detail_pembelian_op`
--
...
--
-- Indeks untuk tabel `detail_obat_praktik`
--
...
--
-- Indeks untuk tabel `detail_pembelian_obat_praktik`
--
...
--
-- Indeks untuk tabel `obat_praktik`
--
ALTER TABLE `obat_praktik`
  ADD PRIMARY KEY (`id_obat_praktik`);

--
-- Indeks untuk tabel `opname_obat`
--
...
--
-- Indeks untuk tabel `opname_obat_praktik`
--
...
--
-- Indeks untuk tabel `pembelian_obat_praktik`
--
...
--
-- AUTO_INCREMENT untuk tabel `detail_obat_praktik`
--
ALTER TABLE `detail_obat_praktik`
...
--
-- AUTO_INCREMENT untuk tabel `detail_pembelian_obat_praktik`
--
ALTER TABLE `detail_pembelian_obat_praktik`
...
--
-- AUTO_INCREMENT untuk tabel `detail_tmp`
--
ALTER TABLE `detail_tmp`
...
--
-- Ketidakleluasaan untuk tabel `detail_obat_praktik`
--
ALTER TABLE `detail_obat_praktik`
...
--
-- Ketidakleluasaan untuk tabel `detail_pembelian_obat_praktik`
--
ALTER TABLE `detail_pembelian_obat_praktik`
...
--
-- Ketidakleluasaan untuk tabel `detail_tmp`
--
ALTER TABLE `detail_tmp`
...
--
-- Ketidakleluasaan untuk tabel `opname_obat`
--
ALTER TABLE `opname_obat`
...
--
-- Ketidakleluasaan untuk tabel `opname_obat_praktik`
--
ALTER TABLE `opname_obat_praktik`
...
--
-- Ketidakleluasaan untuk tabel `pembelian_obat_praktik`
--
ALTER TABLE `pembelian_obat_praktik`
