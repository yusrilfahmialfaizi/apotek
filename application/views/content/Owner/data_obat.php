                        ...
                        <tr>
                          ...
                          <td>
                            <div class="form-group">
                              ...
                              <a href="<?php echo base_url("owner/dataobatpraktik/hapus/$key->id_obat_praktik") ?>" id="id_obat_hapus" name="id_obat_hapus" class="btn btn-danger btn-sm glyphicon glyphicon-remove"></a>
                            </div>
                          </td>
                        </tr>
                        <?php endforeach ?>
