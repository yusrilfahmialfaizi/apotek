        ...
        $(document).ready(function(){
          ...
          $('#add_cart').on('click', function(){
            ...
            $.ajax({
                ...
                method  : "POST",
                data    : {obat: obat, nama_paten: nama_paten, qty: qty, harga: harga, nama_generic : nama_generic, nama_pabrik : nama_pabrik, jenis_obat : jenis_obat, kategori_obat : kategori_obat, per : per},
                success: function(data){
