                  ...
                  <form action="<?php echo base_url("owner/pembelianobat/tambah") ?>" method="post" class="form-horizontal form-label-left">
                    <!-- <div class="form-group">
                        ...
                        <div class="col-md-4 col-sm-9 col-xs-12">
                          <input type="text" class="form-control" id="kode_isi" name="id_obat_isi" value="<?php //echo $kode 
                                                                                                          ?>"  required="required">
                        </div>
                      </div> -->
                    <div class="form-group">
                ...
                <div class="x_content">
                  <form action="<?php echo base_url("owner/pembelianobat/add") ?>" method="post">
                    ...
                    <!-- <div class="form-group">
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Total Harga<span class="required">*</span></label>
                              <div class="col-md-5 col-sm-9 col-xs-12">
                                <input type="number" class="form-control" id="total_harga" name="total_harga" placeholder="Rp. " required="required" value="<?php echo $this->cart->total() ?>" readonly="readonly">
                              </div>
                          </div>
                        </div>
                      </div> -->
