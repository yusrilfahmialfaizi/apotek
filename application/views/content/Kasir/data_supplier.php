                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group">
                                                ...
                                                <a href="<?php echo base_url("kasir/data_supplier/hapus/$key->id_supplier") ?>" id="id_supplier_hapus" name="id_supplier_hapus" class="btn btn-danger btn-sm glyphicon glyphicon-remove"></a>
                                            </div>
                                        </td>
                                    </tr>
                                <?php endforeach ?>
