                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group">
                                                ...
                                                <a href="<?php echo base_url("kasir/data_obat/hapus/$key->id_obat") ?>" id="id_obat_hapus" name="id_obat_hapus" class="btn btn-danger btn-sm glyphicon glyphicon-remove"></a>
                                            </div>
                                        </td>
                                    </tr>
                                <?php endforeach ?>
