      ...
      <div class="right_col" role="main">
        <div class="">
          ...
          <?php foreach ($this->cart->contents() as $cart) { ?>
            <div class="modal fade edit_obat<?php echo $cart['rowid'] ?>" role="dialog" aria-hidden="true">
              <div class="modal-dialog modal-lg">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-4 col-sm-9 col-xs-12">
                          <input type="text" class="form-control" id="nama_paten_edit" name="nama_paten_edit" readonly="readonly" required="required" placeholder="Nama Paten" value="<?php echo $cart['name'] ?>">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Nama Generic <span class="required">*</span></label>
                        <div class="col-md-4 col-sm-9 col-xs-12">
                          <input type="text" class="form-control" id="nama_generic_edit" name="nama_generic_edit" placeholder="Nama Generic" required="required" readonly="readonly" value="<?php echo $cart['nama_generic'] ?>">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Nama Pabrik <span class="required">*</span></label>
                        <div class="col-md-4 col-sm-9 col-xs-12">
                          <input type="text" class="form-control" id="nama_pabrik_edit" name="nama_pabrik_edit" readonly="readonly" placeholder="Nama Pabrik" required="required" value="<?php echo $cart['nama_pabrik'] ?>">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Jenis <span class="required">*</span></label>
                        <div class="col-md-4 col-sm-9 col-xs-12">
                          <input type="text" class="form-control" id="jenis_obat_edit" name="jenis_obat_edit" placeholder="Jenis" readonly="readonly" required="required" value="<?php echo $cart['jenis'] ?>">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Kategori <span class="required">*</span></label>
                        <div class="col-md-4 col-sm-9 col-xs-12">
                          <input type="text" class="form-control" id="kategori_obat_edit" name="kategori_obat_edit" placeholder="Kategori" required="required" readonly="readonly" value="<?php echo $cart['kategori'] ?>">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Harga Beli Rp. <span class="required">*</span></label>
                        <div class="col-md-4 col-sm-9 col-xs-12">
                          <input type="number" class="form-control" id="harga_edit" name="harga_edit" readonly="readonly" placeholder="Rp." required="required" readonly="readonly" value="<?php echo $cart['price'] ?>">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Expired <span class="required">*</span></label>
                        <div class="col-md-4 col-sm-9 col-xs-12">
                          <input type="text" class="form-control has-feedback-left" id="single_cal3" placeholder="Expired" name="exp" aria-describedby="inputSuccess2Status4" value="<?php echo date("m/d/Y", strtotime($cart['exp']))  ?>" required="required">
                          <span class="fa fa-calendar-o form-control-feedback left" aria-hidden="true"></span>
                          <span id="inputSuccess2Status4" class="sr-only">(success)</span>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Jumlah <span class="required">*</span></label>
                        <div class="col-md-4 col-sm-9 col-xs-12">
                          <input type="number" min="0" class="form-control" id="qty_edit" name="qty_edit" placeholder="Qty" required="required" value="<?php echo $cart['qty'] ?>">
                        </div>
                      </div>
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                ...
                <div class="x_content">
                  <form action="<?php echo base_url("kasir/Pembelian_obat/add") ?>" method="post">
                    <div class="row">
                      <!-- Large modal -->
                      <div class="form-group">
                        <div class="col-md-10">
                      ...
                      <div class="form-group">
                        <div class="col-md-10">
                          <label class="control-label col-md-2 col-sm-3 col-xs-12">ID Suppiler <span class="required">*</span></label>
                          <div class="col-md-4 col-sm-9 col-xs-12">
                      ...
                      <div class="col-md-3">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="nama_sp" name="nama_sp" readonly />
                        </div>
                      </div>
                      <div class="col-md-3">
                        <div class="form-group">
                          <label for="">Alamat</label>
                          <input type="text" class="form-control" id="alamat_sp" name="alamat_sp" readonly />
                          <!-- <textarea name="alamat_sp" id="alamat_sp" cols="30" rows="10" readonly></textarea> -->
                        </div>
                      </div>
                      <div class="col-md-3">
                        <div class="form-group">
                          <label for="">No. Telepon</label>
                          <input type="number" class="form-control" id="no_telepon_sp" name="no_telepon_sp" readonly />
                        </div>
                      </div>
                      <div class="col-md-3">
                        <div class="form-group">
                          <label for="">Nama Pabrik</label>
                          <input type="text" class="form-control" id="nama_pabrik_sp" name="nama_pabrik_sp" readonly />
                        </div>
                      </div>
      ...
      <script>
        $(document).ready(function() {
          ...
          $("#id_supplier").on("change", function() {
            ...
            $.ajax({
              url: "<?php echo base_url("kasir/pembelian_obat/data_supplier") ?>",
              type: "POST",
              dataType: "JSON",
              data: {
              ...
              success: function(data) {
                $("#nama_sp").val(data.nama);
                $("#alamat_sp").val(data.alamat);
                $("#no_telepon_sp").val(data.no_telepon);
                $("#nama_pabrik_sp").val(data.nama_pabrik);
              }
            })
          });
          ...
          $('#add_cart').on('click', function() {
            ...
            $.ajax({
              ...
              success: function(data) {
                $('#pembelian').html(data);
                document.getElementById("id_obat_isi").value = "";
                document.getElementById("nama_paten_isi").value = "";
                document.getElementById("jumlah_stok_isi").value = "";
                document.getElementById("harga_beli_isi").value = "";
                document.getElementById("nama_generic_isi").value = "";
                document.getElementById("nama_pabrik_isi").value = "";
                document.getElementById("jenis_obat_isi").value = "";
                document.getElementById("kategori_obat_isi").value = "";
              }
            });
          });
          ...
          $('#edit_cart').on('click', function() {
            ...
            $.ajax({
              url: "<?php echo base_url('kasir/pembelian_obat/updatekeranjang'); ?>",
              method: "POST",
              data: {
                rowid: rowid,
                qty: qty,
          ...
          $('#pembelian').load("<?php echo base_url('kasir/pembelian_obat/load_cart'); ?>");
          ...
          $(document).on('click', '#remove_cart', function() {
            ...
            $.ajax({
              url: "<?php echo site_url('kasir/pembelian_obat/hapus_cart'); ?>",
              method: "POST",
              data: {
                row_id: row_id
              },
